  ...
  return (
    <div className="w-full xl:flex xl:justify-between ">
      {!data ? (
        ...
        <div className="flex whitespace-nowrap gap-2 xl:gap-3 max-w-full xl:w-full overflow-x-scroll xl:overflow-x-hidden md:px-6 xl:px-0 py-2 border-y xl:border-y-0 mt-2 xl:mt-0 ">
          <div>
